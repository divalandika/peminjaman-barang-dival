		...
		<table class="table">
			...
			<tbody>
				...
				while($d = mysqli_fetch_array($data)){
								...
								<form action="proses_update_pembelian.php" method="post">
									<div class="modal-body">				
										<div class="form-group">
											<input type="text" name="PeminjamID" value="<?php echo $d['PeminjamID']; ?>" class="form-control" hidden>
										</div>
										<div class="form-group">
											<label>Nama Peminjam</label>
											<input type="text" name="NamaPeminjam" value="<?php echo $d['NamaPeminjam']; ?>" class="form-control">
										</div>
										<div class="form-group">
					...
					<!-- Modal Hapus Data-->
					<div class="modal fade" id="hapus-data<?php echo $d['PeminjamID']; ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
								...
								<form method="post" action="proses_hapus_pembelian.php">
									<div class="modal-body">
										<input type="hidden" name="PeminjamID" value="<?php echo $d['PeminjamID']; ?>">
